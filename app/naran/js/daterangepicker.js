...
!function ($, moment) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        var DRPTemplate = '<div class="daterangepicker dropdown-menu">' +
                ...
                '<div class="calendar right"></div>' +'<div class="ranges">' +
                  '<div class="range_inputs">' +
                    ...
                    '<button class="applyBtn" disabled="disabled"></button>'+'<button class="cancelBtn"></button>&nbsp;'  +'</div>'+
    ...
    DateRangePicker.prototype = {
        ...
        renderCalendar: function (calendar, selected, minDate, maxDate) {
            ...
            if (!minDate || minDate.isBefore(calendar[1][1])) {
                html += '<th class="prev available"><i class="fa"></i></th>';
            } else {
                html += '<th></th>';
            }
            ...
            if (this.showWeekNumbers)
                html += '<th>' + this.locale.weekLabel + '</th>';

            $.each(this.locale.daysOfWeek, function (index, dayOfWeek) {
                html += '<th style="background:#f4f4f4;font-size:12px;line-height:30px;height:30px;font-family:Microsoft Yahei;">' + dayOfWeek + '</th>';
            });

            html += '</tr>';
            html += '<tr><td colspan="7" style="height:8px;"></td></tr>';//keep the gap
            html += '</thead>';
            html += '<tbody>';
